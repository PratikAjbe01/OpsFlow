    ...
    <div className="p-5 space-y-8 h-full overflow-y-auto">
      ...
      <section className="space-y-4">
        ...
        <ColorPicker
          ...
          onChange={(v) => handleChange("cardColor", v)}
        />
        <ColorPicker
          label="Text Color"
        ...
        <ColorPicker
          ...
          onChange={(v) => handleChange("btnColor", v)}
        />
        <ColorPicker
          label="Border Color"
          ...
          <div className="grid grid-cols-5 gap-2">
            {["none", "sm", "md", "lg", "full"].map((opt) => (
              <button
                ...
                className={`h-8 rounded border text-gray-700 ${
                  theme.borderRadius === opt
                    ? "bg-blue-100 border-blue-500 text-blue-700"
                    : "bg-gray-50 border-gray-200 hover:border-gray-300"
                }`}
                title={opt}>
                <div
                  className={`w-4 h-4 mx-auto border-t-2 border-l-2 border-current ${
                    opt === "none"
                      ? "rounded-none"
                      : opt === "sm"
                      ? "rounded-sm"
